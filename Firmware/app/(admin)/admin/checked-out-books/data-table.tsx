    ...
    return (
      <Empty className='border'>
        <EmptyHeader>
          ...
          <EmptyTitle>No Books Checked out yet.</EmptyTitle>
          <EmptyDescription>This is where checked out books will appear.</EmptyDescription>
        </EmptyHeader>
      </Empty>
    )
  }
  ...
  return (
    <div>
      <Table className='border-2'>
        <TableCaption>List of checked out Books at IKPB</TableCaption>
        <TableHeader>
            <TableRow>
